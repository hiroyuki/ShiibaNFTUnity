...
public class DepthMeshGenerator
{
    ...
    private void SetComputeShaderParameters(CameraParameters cameraParams)
    {
        ...
        {
            depthPixelProcessor.SetVector("colorDistortion", new Vector4(color_distortion[0], color_distortion[1], color_distortion[6], color_distortion[7])); // k1, k2, p1, p2
            depthPixelProcessor.SetVector("colorDistortion2", new Vector4(color_distortion[2], color_distortion[3], color_distortion[4], color_distortion[5])); // k3, k4, k5, k6
        }
        ...
        depthPixelProcessor.SetBool("showAllPoints", showAllPoints);
